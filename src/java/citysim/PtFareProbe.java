...
public final class PtFareProbe {
    ...
    private static final class Fixture {
        ...
        private Fixture() {
            ...
            fares.busBandsKm = BANDS_KM;
            fares.busAdultOffpeak = ADULT_OFFPEAK;
            fares.busAdultPeak = ADULT_PEAK;
            fares.busChildOffpeak = CHILD_OFFPEAK;
            fares.busChildPeak = CHILD_PEAK;
            fares.dailyCapAdult = CAP_ADULT;
            fares.dailyCapChild = CAP_CHILD;
            fares.dailyCapSenior = CAP_SENIOR;
            fares.seniorPerFareCap = 1.25;
            fares.transferDiscountAdult = 2.00;
            fares.transferDiscountChild = 1.00;
            fares.transferWindowMin = 60;
            fares.peakMorningStartH = 7.0;
            fares.peakMorningEndH = 9.0;
            fares.peakEveningStartH = 16.0;
            fares.peakEveningEndH = 18.0;
            fares.railPeakMorningStartH = 6.5;
            fares.offPeakAllDay = false;
            fares.childMinAge = 5;
            fares.childMaxAge = 15;
            fares.seniorMinAge = 60;
