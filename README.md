...
| Input registry | 469 controllable fields, each with units, provenance and a sweep or a held-fixed rule, and each sweep saying what it is for |
...
cities/newcastle/            ONE CITY - every Newcastle/NSW/Australia-specific input
  registry/                  the 469 declared values, with units, provenance, sweeps
