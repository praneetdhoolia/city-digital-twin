...
| Input registry | 408 controllable fields, each with units, provenance and a sweep or a held-fixed rule |
...
cities/newcastle/            ONE CITY - every Newcastle/NSW/Australia-specific input
  registry/                  the 408 declared values, with units, provenance, sweeps
