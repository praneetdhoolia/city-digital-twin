...
| Input registry | 388 controllable fields, each with units, provenance and a sweep or a held-fixed rule |
...
cities/newcastle/            ONE CITY - every Newcastle/NSW/Australia-specific input
  registry/                  the 388 declared values, with units, provenance, sweeps
