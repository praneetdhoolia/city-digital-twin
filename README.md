...
| Input registry | 377 controllable fields, each with units, provenance and a sweep or a held-fixed rule |
...
cities/newcastle/            ONE CITY - every Newcastle/NSW/Australia-specific input
  registry/                  the 377 declared values, with units, provenance, sweeps
