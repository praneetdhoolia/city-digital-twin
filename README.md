...
| Input registry | 403 controllable fields, each with units, provenance and a sweep or a held-fixed rule |
...
cities/newcastle/            ONE CITY - every Newcastle/NSW/Australia-specific input
  registry/                  the 403 declared values, with units, provenance, sweeps
