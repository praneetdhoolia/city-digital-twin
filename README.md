...
| Input registry | 517 controllable fields, each with units, provenance and a sweep or a held-fixed rule, and each sweep saying what it is for |
...
cities/newcastle/            ONE CITY - every Newcastle/NSW/Australia-specific input
  registry/                  the 517 declared values, with units, provenance, sweeps
