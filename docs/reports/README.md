...
|---|---|---|---|---|
| 13 | [`20260918T182209_project_report.html`](20260918T182209_project_report.html) | `e37035d` | 18 September 2026 | Mumbai readiness assessment: ten verified findings, led by unscaled transit standing capacity. The latest result remains two modes inside the band; full package audit fails six checks. Fix capacity scaling and validate each mode before expansion. Three delegated reviewers stopped on workspace credit errors; unfinished factor and document reviews are explicit gaps. |
| 12 | [`20260916T062246_project_report.html`](20260916T062246_project_report.html) | `d6f9cdf` (the PR #226 merge, with the session's in-flight tree; the routers pair `20260915T000704_250it_25pct` read at its 250-iteration horizon, the third result, a null against arm 0) | 16 September 2026 | The first controlled reading is a null: the routers pair moved nothing, 2 of 12 inside 10 % on three results; the scoring pair launched on its probe price. 91 findings, 2 defects fixed in the same tree (the pricer's phantom setup on an orphan; residents read from today's population), 59 ledger rows. Top optimisation: a JFR probe of the mobsim (65 % of an iteration). Alone on the per-mode rung; top missing factor: ride's choice-set ceiling. |
