...
**Last updated:** 19 September 2026. Mumbai hired-supply case completed with experienced waits and refusals (§9.200).
The scoreboard still describes Newcastle; Mumbai remains provisional, with full-city scaling and calibration unverified.
...
| P4 calibration | 🟡 | the newest run on disk is `20260919T155059_8it_100pct-mumbai-smoke`, which **RAN TO ITS LAST ITERATION**: the hired-supply case completed at iteration 8 (9.200), no calibration claim. Newcastle remains at `20260916T063903_250it_25pct`, completed inside F35 (9.177); three F35 results agree within 0.35 pp. The next calibrated arm opens a new family. The 16 September approval is spent. |
...
| `20260919T142650_8it_100pct-mumbai-smoke` | completed | - | 8 | ran_to_last_iteration `_run.json` |

218 run directories on disk; `results/INDEX.md` labels every one. A dead run states its cause in its own `_meta.json`.
<!-- generated:runs end -->

## Next

<!-- generated:lane start -->
1. **Add coherent Mumbai households and realistic hired-trip responses** **(recommended)** - Hired-supply case completed in 910.5 s including preparation. No new run launched; multi-hour arms still require stated-cost approval.; opens a family; blocked on: No missing decision for bounded development. Household sharing, refusal fallback, full hired tariffs, spatial fleet operation, rare-mode coverage and scaling remain open. (9.200: the bounded fleet case completed with native waits, balanced request accounting and finite retained scores. Timeouts still abort the day; no operating-fleet or ridership calibration is claimed.;)
