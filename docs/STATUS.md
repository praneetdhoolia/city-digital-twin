...
**Last updated:** 22 September 2026 (sixtieth session, continued). The Java fold landed on a 1 % smoke; MMRDA's daily metro ridership is imported and is the Mumbai metro target; the printed timetables, projected vehicles, weighted destinations and graded links of §9.209 stand (§9.210).
The scoreboard is Newcastle's; Mumbai reads at no fraction this host carries (D15 host: the user procures it, goal paused). The TUS 2024 unit files still wait on the user's browser.
...
| P4 calibration | 🟡 | the newest run on disk is `20260922T172813_4it_1pct`, which **RAN TO ITS LAST ITERATION**: the 1 % Newcastle structural smoke of the Java fold (§9.210: fleet = declared × sample, retimed = restoreRetimed); the Mumbai checks of §9.209 and the 1 % cases of §9.206 stand, D15 takes a 384-512 GB host. Newcastle remains at `20260916T063903_250it_25pct` inside F35 (§9.177). **The next 25 % arm opens a family (#237).** No run approval stands. |
...
| Position pages | [light-rail-and-ferry](positions/light-rail-and-ferry.md) (22 September 2026 (sixtieth session)) · [monitoring-and-gates](positions/monitoring-and-gates.md) (22 September 2026 (fifty-eighth session)) · [motorbike-truck-and-freight](positions/motorbike-truck-and-freight.md) (16 September 2026 (fifty-third session)) · [network-and-inputs](positions/network-and-inputs.md) (22 September 2026 (sixtieth session)) · [population-and-demand](positions/population-and-demand.md) (22 September 2026 (sixtieth session)) · [public-transport-and-yardsticks](positions/public-transport-and-yardsticks.md) (22 September 2026 (sixtieth session)) · [ride-and-pairing](positions/ride-and-pairing.md) (22 September 2026 (sixtieth session)) · [runs-and-economics](positions/runs-and-economics.md) (17 September 2026 (fifty-fourth session)) · [sampling-and-families](positions/sampling-and-families.md) (22 September 2026 (fifty-eighth session)) · [seed-and-choice-set](positions/seed-and-choice-set.md) (17 September 2026 (fifty-fourth session)) · [signals-and-crossings](positions/signals-and-crossings.md) (16 September 2026 (fifty-third session)) · [taxi-and-rideshare](positions/taxi-and-rideshare.md) (22 September 2026 (sixtieth session)) · [walk-and-bike](positions/walk-and-bike.md) (17 September 2026 (fifty-fourth session)) |
<!-- generated:state end -->
