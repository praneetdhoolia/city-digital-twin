...
- **Registry**: **560 fields** (`cities/newcastle/docs/reference/CONFIG_REFERENCE.md`; §9.167, #198, §9.177); `check_hardcoding.py --strict` at 0; every non-observed field carries a sweep, `held_fixed` or `derived_from`; three unobtained fields `value: null` (§15); no key carries a currency (§9.140, #62).
