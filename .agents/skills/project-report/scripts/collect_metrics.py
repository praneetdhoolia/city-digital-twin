...
from anywhere else.
    ...
    python .agents/skills/project-report/scripts/collect_metrics.py OUT_DIR
    python .agents/skills/project-report/scripts/collect_metrics.py OUT_DIR --no-github
    python .agents/skills/project-report/scripts/collect_metrics.py OUT_DIR --no-growth
