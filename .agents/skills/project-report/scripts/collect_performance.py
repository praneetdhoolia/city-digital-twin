...
and nothing typed.
    ...
    python .agents/skills/project-report/scripts/collect_performance.py OUT_DIR
    python .agents/skills/project-report/scripts/collect_performance.py OUT_DIR --no-sizes   # skip the disk walk
