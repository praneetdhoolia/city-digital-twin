...
OVERRIDES = {
    ...
    'RUN.machine.heap_floor_gib': dict(decisions_ref='9.205', value=13.7, source='measured', status='active',
                                       held_fixed={'rule': 'the peak of the explicit 1,000-person case (the network, the combined feed and the routers, no population to speak of), read from its gc.log; re-read from every longer case', 'decisions_ref': '9.205', 'departure_requires': 'a higher peak at a negligible population in a later Mumbai gc.log'},
                                       description='The sample-independent part of the heap rule. MEASURED: 13.74 GiB of 16g in the gc.log of 20260921T182708_2it_100pct, the explicit 1,000-person case - the mapped regional network, the combined feed and the routers before any population to speak of.'),
    'RUN.machine.heap_per_fraction_gib': dict(decisions_ref='9.205', value=3600.0, source='measured', status='active',
                                              held_fixed={'rule': 'the slope between the two measured peaks: 13.74 GiB at a negligible population and 17.30 GiB at 0.001 of the core households (26,884 agents, 20260921T220701_2it_0.1pct), 3.56 GiB per 0.001 - about 140 KB an agent at two plans, the reference city rate; re-read at every new fraction', 'decisions_ref': '9.205', 'departure_requires': 'a peak at another fraction in a Mumbai gc.log'},
