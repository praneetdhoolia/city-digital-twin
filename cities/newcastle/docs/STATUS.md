...
| Blocking state | **A RUN IS IN PROGRESS - THE MACHINE IS NOT FREE.** `results/20260830T170743_300it_10pct` (S2, WEEKDAY, 10%, 300 it, innovation off at 240, overlay `f19_gate_10pct`, Task Scheduler `citysim_run_20260830T170742`) is the **FIRST F19 ARM (§9.128)**, launched 30 Aug 17:07 on the F18 demand with declared ride pairs served by the driver's detour; first gate at iteration 100 (~20:10 at ~106 s/it), then 200 and 300, per mode, under the standing /goal directive. The valid F18 arm `aborted_20260830T163010_300it_10pct` was stopped at iteration 1: its iteration 0 refused 2,053 of 6,966 ride legs on endpoints, the shared rides among them, so it could measure nothing about the demand it was launched to test. NEVER compare across the F19 boundary, a sample fraction or a network build. |
...
| 4.15.29 | **Run the first F19 arm and gate it per mode at 100 / 200 / 300** | #48 #86 #91 #49 #30 #93 #94 #82 | **RUNNING** — `20260830T170743_300it_10pct`, launched 17:07 detached (`citysim_run_20260830T170742`); first gate at iteration 100 (~20:10) |
