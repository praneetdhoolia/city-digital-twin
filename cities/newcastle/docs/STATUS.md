...
| 4.15.27 | **Rebind, rebuild and run the first valid F18 arm; gate it per mode at 100 / 200 / 300** | #48 #86 #91 #49 #30 #93 #94 #82 | **IN PROGRESS** — shared pass re-run on all three day types under the hash rule, plans, run inputs, manifest, a 10% sample asserted within 8.5–11.5% of persons, smoke, launch |
