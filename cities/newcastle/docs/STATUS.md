...
| Committed data package | **489 files** in [`data/MANIFEST.csv`](../data/MANIFEST.csv) · `check_manifest.py` passes · `check_package.py` **1,433 checks, ALL PASSED, 25 Aug sixth session** (2 standing warnings) — now a portable harness over city-owned expectations ([`cities/newcastle/tests/package_expectations.json`], #62 B4) |
